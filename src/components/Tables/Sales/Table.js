...
function Table() {
    ...
    const handleTipoChange = (e) => setSelectedTipo(e.target.value || ''); // Asigna '' si se selecciona el valor por defecto
            ...
            <div className='__table'>
                ...
                <div className='__table_body'>
                    {filteredSales.length > 0 ? (
                        ...
                        <>
                            <div style={{ width: '100%', height: '60px', display: 'grid', placeItems: 'center' }}>
                                No hay datos aún
                            </div>
                        </>
                    )}
